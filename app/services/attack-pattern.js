...
export default Ember.Service.extend({
    ...
    /**
     * Unspecified Kill Chain Phase Name
     *
     * @type {string}
     */
    unspecifiedKillChainPhaseName: 'unspecified',
    ...
    getPhaseNameAttackPatterns(attackPatterns) {
        const hash = {};
        const unspecifiedKillChainPhaseName = this.get("unspecifiedKillChainPhaseName");
        hash[unspecifiedKillChainPhaseName] = [];

        attackPatterns.forEach(function(attackPattern) {
            let killChainPhases = attackPattern.get("kill_chain_phases");

            if (Ember.isEmpty(killChainPhases)) {
                let attackPatternsProxies = hash[unspecifiedKillChainPhaseName];
