...
/**
 * Select Search Field Component using Ember Power Select search.  This is used when building relationship objects.
 *
 * @module
...
export default Ember.Component.extend( {
    ...
    actions: {
        ...
        addExternalReference(item) {
            ...
            let references = Ember.get(item, "related_external_references");
